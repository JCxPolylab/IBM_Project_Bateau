...
namespace CATJ_ethernet {
    ...
    namespace {
        ...
        bool setNonBlockingSocket(CATJ_ethernet::EthernetLink::socket_handle_t s, bool enabled)
        {
#if defined(_WIN32)
        ...
        void closeNativeSocket(CATJ_ethernet::EthernetLink::socket_handle_t s)
        {
#if defined(_WIN32)
